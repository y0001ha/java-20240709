...
public class Variable {
	...
	public static void main(String[] args) {
		// 변수 (Variable)
				...
				// 변수를 생성(선언)할 때는 반드시 해당 변수가 어떤 형태(데이터타입)의 데이터를 가질 수 있는지 지정해야 함
				...
				// 변수 초기화(초기값을 넣는) 방법
				// 변수 = 데이터;
				number1 = 9;   // number1라는 메모리 공간에 9라는 데이터를 초기값으로 넣음 --->>> 초기화
				...
				int number3;
				System.out.println(number3);  --->>> 오류  */
				
				/* 변수에 지정된 타입의 데이터가 아니면 할당이 불가능
				int number3 = 3.14; */
				
				number1 = 12;  // 처음 변수에 값을 할당하는 행위가 아니기 때문에 해당 코드는 초기화가 아님. --->>> 재할당
				System.out.println(number1);
				...
				// - Snake Case : 띄어쓰기를 표현할 때 띄어쓰기 자리에 _로 표현
				...
				// 리터럴(값 그자체)에 이름을 부여하기 위한 용도로 상수를 많이 사용함
				final double IPHONE_15_PRO_HEIGHT = 146.6; // 146.6 이 리터럴상수
