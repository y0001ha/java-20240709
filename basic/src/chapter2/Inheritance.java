...
class SalesMan extends Human {
	...
	// 규칙
	// 1. 상위 클래스에서 선언된 메서드와 메서드이름, 매개변수의 조합이 같아야함
...
public class Inheritance {
	...
	public static void main(String[] args) {
		...
		Developer deverloper1 = new Developer("홍길동", 20, new String[] {"java", "python"} );
		SalesMan salesMan1 = new SalesMan("이영희", 25, 300000);
		
		System.out.println(deverloper1.name);
		System.out.println(deverloper1.age);
		System.out.println(deverloper1.skills);
		deverloper1.sayHello();
		deverloper1.develop();
