...
// 반드시 추상 클래스 내부 혹은 인터페이스에서만 선언할 수 있음
// 반드시 추상클래스를 확장한 하위 클래스에서 재정의(오버라이드)하여 구현해야함
...
class SalesMan2 extends Human2 {
	...
	@Override
	void greet () {
		System.out.println("저는 " + name + "이고 " + age + "세이면서 영업사원입니다.");
	}
}
...
public class AbstractClass {
	...
	public static void main(String[] args) {
		...
		developer.name = "홍길동";
		developer.age = 20;
		developer.greet(); //--->>## 반드시 greet을 오버라이드 해서 만들겠다고 했을 때
