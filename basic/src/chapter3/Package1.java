...
public class Package1 {
	...
	public static void main(String[] args) {
		...
		// 일반적으로 기본형 데이터 타입의 풀네임을 사용하고 첫글자를 대문자로 지정
		...
		// Math 클래스 : 수학 연산과 관련된 다양한 메서드를 제공해주는 믈래스
		// 모든 메서드가 static인 정적 메서드 -->> static 인스턴트 생성없이 바로 사용 가능
		...
		// 소수점 자리
		// 3.1415 * 100 => 314.15
		// round(3.1415 * 100) => 314
		// round(3.1415 * 100) / 100.0 => 3.14
