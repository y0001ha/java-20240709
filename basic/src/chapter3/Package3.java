...
public class Package3 {
	...
	public static void main(String[] args) {
		...
		// 범위 제약
		System.out.println(random.nextInt(3)); // 0 ~ 2 난수 생성
		System.out.println(random.nextInt(3) + 1); // 1 ~ 3 난수 생성
		...
		// LocalDateTime 클래스 : Java 8 Date를 대체하기 위해 사용되는 클래스
		...
		now.withYear(2025); now.withHour(21);  // --->> 이렇게만 하면 인스턴스 변경 안됨
		now = now.withYear(2025); now.withHour(21); // -->> 바뀜
		System.out.println(now);
		...
		// DateTimeFormatter.ofPattern("a hh:mm yyyy-MM-dd")
